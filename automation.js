...
program
    ...
    .option('-pr, --prompt [xxx]', 'AI 文章配图prompt')
...
if (program.configPath !== undefined) {
    try {
        ...
        prompt = jsonContent.prompt || undefined;
...
if (prompt === undefined) {
    if (program.prompt === undefined) {
        console.log('缺少公众号配图prompt， -h 了解如何使用');
        return;
    } else {
        prompt = String(program.prompt);
    }
}
    ...
    return new Promise(async (resolve, reject) => {
        ...
        try {
            ...
            if (last_edit) {
                ...
                console.log("新建群发文章中...");
                const NEW_POST = '#app > div.main_bd_new > div:nth-child(3) > div.weui-desktop-panel__bd > div > div:nth-child(2)'
